...
function ChordComposer({
  ...
  return (
    <div className="composer-sections">
      <section className="composer-section" aria-labelledby="modal-generator-heading">
      ...
      <section className="composer-section" aria-labelledby="modal-editor-heading">
        <div className="panel-heading">
        ...
        <div className="editor-content modal-editor-content">
          ...
          <div className="manual-builder">
            <div className="manual-builder-header">
              ...
              <button className="secondary-button" onClick={onViewportSync} type="button">
            ...
            <div aria-label={text.frettingInput} className="manual-grid" role="group">
      ...
      <section className="composer-section" aria-labelledby="modal-info-heading">
        <div className="panel-heading">
        ...
        <dl className="info-list">
          ...
          <div>
            ...
            <dd>{summary.chordTones.length > 0 ? summary.chordTones.join(', ') : '-'}</dd>
          </div>
          <div>
            <dt>{text.uniqueNotes}</dt>
            <dd>{summary.uniqueNotes.length > 0 ? summary.uniqueNotes.join(', ') : '-'}</dd>
          </div>
          <div>
